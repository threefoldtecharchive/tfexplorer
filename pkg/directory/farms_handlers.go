...
func (s *FarmAPI) registerFarm(r *http.Request) (interface{}, mw.Response) {
	...
	if err != nil {
		return nil, mw.GenericDBError(err, errFailedToRegisterFarm)
	}
...
func (s *FarmAPI) updateFarm(r *http.Request) (interface{}, mw.Response) {
	...
	if err != nil {
		return nil, mw.GenericDBError(err, fmt.Errorf("farm with id %s not found", sid))
	}
	...
	if err != nil {
		return nil, mw.GenericDBError(err, fmt.Errorf("failed to update farm with farmID %s", sid))
	}
...
func (s *FarmAPI) listFarm(r *http.Request) (interface{}, mw.Response) {
	...
	if err != nil {
		return nil, mw.GenericDBError(err, errFailedToListFarms)
	}
